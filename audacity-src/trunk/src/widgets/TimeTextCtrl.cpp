...
bool TimeTextCtrl::Layout()
{
   ...
   memDC.SeONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_ize, wxFIXED, wxNORMAL, wxNORMAL));
   ...
   if (mDigitFont)
      delete mDigitFont;
   mDigitFont ONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_ize, wxFIXED, wxNORMAL, wxNORMAL);
   ...
   if (mLabelFont)
      delete mLabelFont;
   mLabelFont ONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_ize, wxFIXED, wxNORMAL, wxNORMAL);
