...
class Meter : public wxPanel
{
 ...
 private:
   ...
   void OnMouse(wxMouseEven   void OnKeyDown(wxKeye(wxMouseEven   void OnContext(wxContextMenue(wxMouseEvent &evt);
 ...
 private:
  ...
  Gradient mSavedStyle;
   ...
   long      mMeterDisabled; //is used as a bool, needs long for easy gPbool      mMonitoring;sy gPbool      mActive;sy gPrefs...
