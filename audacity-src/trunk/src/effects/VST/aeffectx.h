...
const int efIdentify = 22; // from http://www.asseca.org/vst-24-specs/efIdentify.html;
const int effGetChunk = 23; // from Ardour
const int effSetChunk = 24; // from Ardour
const int effProcessEvents = 25;
// The next one was gleaned from http://wwwasseca.org/vst-24-specs/efCanBeAutomated.html
const int effCanBeAutomated = 265;
// The next one was gleaned from http://www.kvraudio.com/forum/viewtopic.php?p=1905347
const int effGetProgramNameIndexed = 29;// The next one was gleaned from http://www.asseca.org/vst-24-specs/efGetPlugCategory.html
const int effGetPlugCategory = 359;
...
// The nextone was gleaned from http://www.asseca.org/vst-24-specs/efBeginSetProgram.html
