...
WX_DEFINE_USER_EXPORTED_ARRAY(Effect *, EffectArray, class AUDACITY_DLL_API);WX_DECLARE_STRING_HASH_MAP_WITH_DECL(Effect *, EffectMapy, class AUDACITY_DLL_API);
...
class AUDACITY_DLL_API EffectManager
{
 ...
 public:
   ...
   void RegisterEffect(Effect *f, int Additio   void RegisterEffect(ModuleInterface *p, gisterEffect(Effect *f, int AdditionalFlags=0);
