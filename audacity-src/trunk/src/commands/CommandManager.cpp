...
{
   CommandListEntry *enentry->label = newLabel.BeforeFirst(wxT('\t'));
      entry->menu->SetLabel(entry->id, entry->label->label = newLabel;
...
#endifl#endifeAccels(mOpenMenu, false);
