...
class ImageRoll
{
 public:
   ...
   void Draw(wxDC &dc, wxRect rect,
       wxRasterOperationMode   int logicalFunc = wxCOPY);
 ...
 protected:
   ...
   void DrawBitmap(wxDC &dc, wxBitmap &bitmap,
                   int xwxRasterOperationModent y, int logicalFunc = wxCOPY);
...
class ImageRollPanel : public wxPanel
{
 public:
   ...
   void SetLwxRasterOperationMode func);
 ...
 protected:
   ...
   wxRasterOperationModeImageRoll;
