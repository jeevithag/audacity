   ...
   mDisable(NULL)
{
   ...
   mStartTime = wxGetLocmeMillis().GetValue();
   ...
   // Even though we won't necessarily show t//
   ...
   // no editing in any project until Timer Record finishes. ow the dialog due to the the 500ms
